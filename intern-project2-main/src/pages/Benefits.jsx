...
<div className='text-center'>
       ...
       <h1 className=' font-semibold sm:text-3xl text-2xl  max-md:inline-block max-md:px-2 max-md:border-b-[#af7501] max-md:border-b-2   max-sm:py-1 text-center  px-1   text-[#0f5f17]'>Benefits of Black Rice Salt </h1>
            ...
            <div className='my-2 md:my-4'>
                ...
                <li className='md:text-lg'>Black rice can also be helpful to some extent in the prevention of cancer. Because it has the effect of antioxidant properties
                ...
                <li className='md:text-lg'>Consumption of black rice can also be very useful in controlling weight. Research done on about 40 overweight women
                    has shown that it is also useful in controlling weight.</li>
                <li className='md:text-lg'>Black rice can also be consumed to keep the heart healthy. It prevents the accumulation of plaque in the blood vessels. Plaque is a
                    sticky substance that can build up in the arteries and increase
                    the risk of heart attack, heart disease, and stroke. </li>
            </div>
            ...
            <div className='my-2 md:my-4'>
                ...
                <li className='md:text-lg'>Antioxidants like anthocyanin are found in rice. These elements boost heart health . </li>
                <li className='md:text-lg'>Black salt rice is a grain that improves skin texture and skin health.</li>
                <li className='md:text-lg'>Black salt rice is rich in iron and zinc apart from protein in rice and
                    that is why it is a grain that removes weakness. </li>

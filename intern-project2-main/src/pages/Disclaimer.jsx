...
const Disclaimer = () => {
  return (
    ...
    <h1 className=' font-semibold sm:text-3xl text-2xl  inline-block px-2 border-b-[#af7501] mb-3 py-1 border-b-2 text-[#0f5f17]'>Diclaimer </h1>
            
            <p className='pt-1 md:text-lg'>Your access to and use of this website is subject to your compliance with all applicable laws and 
            ...
            and republication without the written permission of APEDA is expressly prohibited. </p>
    
    


            <p className='md:text-lg my-2 md:my-4'>Unauthorized use of documents, images, software and other proprietary material on this Site may violate copyright, 
            trademark, privacy, right to publicity, export and communications laws and regulations of any country. </p>
        
    
            <p className='md:text-lg my-2 md:my-4'>All the contents of this Site are only for general information or use. They do not constitute advice and should not be relied upon in making (or refraining from making) any decision.
The data referenced in the system do not have any legal sanctity and is for general reference only.The user may like to verify official publications for DGCI&S, Kolkata for any further reference. </p>
    
<p className='md:text-lg my-2 md:my-4'>Contents of this web site are subject to change from time to time. All efforts are made to keep the site up to 
date, but at no given time can we guarantee the information to be up to date. For any further clarifications, amendments, etc, kindly contact to the office. </p>
    
<p className='md:text-lg my-2 md:my-4'>Links contained in this Site to other websites, if any, are intended only for informational purposes. Neither Kalanamak Scented Paddy Production & Conservation Society nor this Site is sponsored or affiliated with 
...
Crossing, Siddharthnagar, Uttar Pradesh, India  </p>


<p className='md:text-lg my-2 md:my-4'>The trademarks, service marks and logos used on this Site are trademarks of Kalanamak Scented Paddy Production & Conservation Society and/ or others. No license or right to use any 
...
Crossing, Siddharthnagar, Uttar Pradesh, India . Other brands, product names,
 trademarks and logos appearing on this Site are the property of their respective owners. </p>

      ...
      <div>
        ...
        <div className='my-3 md:my-8 lg:my-9  lg:px-16 md:px-12 px-3'>
          <div className='text-center lg:py-2'>
                <h1 className='font-semibold lg:text-3xl text-2xl px-2 text-[#0f5f17] inline-block border-b-[#af7501] border-b-2 py-1 '>Proof of Origin</h1>
                </div>
...
recovered from one of the rooms, which was supposed to be the kitchen store. </p>
        ...
        <h1 className='font-bold text-center md:text-3xl  text-2xl py-2 text-white'>Method Of Production</h1>
...
<h2 className='font-semibold md:text-[28px]  text-2xl py-1 border-b-[#af7501] border-b text-[#0f5f17]'>Inspection Body </h2>

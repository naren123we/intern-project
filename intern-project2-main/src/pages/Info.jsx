...
<div className='lg:px-32 md:px-12 sm:px-5 px-3  lg:py-8 py-4'>
   <h1 className='text-center md:text-3xl text-2xl max-sm:py-1 font-bold text-[#0f5f17]'>General Information</h1>
...
the said area, </li>
    ...
    <li className='md:text-lg'> It should have a special quality or characteristics unique to the geographical 
indication </li>
   </div>
...
others.  </li>
    <li className='md:text-lg'> It boosts exports of Indian Geographical indications by providing legal 
Protection. </li>
    <li className='md:text-lg'> It promotes economic Prosperity of Producers.</li>
    <li className='md:text-lg'> It enables seeking legal protection in other WTO member countries. 
</li>
  </div>
...
infringement.  </li>
    <li className='md:text-lg'>The registered proprietor and authorized users can initiate infringement 
actions.</li>
    <li className='md:text-lg'>The authorized users can exercise right to use the Geographical indication. 
</li>
  </div>
  <div className='my-2 md:my-4'>
...
manner which misleads the public as to their geographical origins.  </li>
    <li  className=' md:text-lg'> When unauthorized use indicates or suggests that such goods originate in a 
geographical area other than the true place of origin of such goods in a 
manner which misleads the public as to their geographical origins.</li>

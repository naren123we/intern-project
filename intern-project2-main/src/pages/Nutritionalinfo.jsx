...
<div>
    <h1 className=' text-center font-semibold sm:text-3xl text-2xl  border-b-[#af7501] mb-3 border-b text-[#0f5f17]'>Properties Of Black Rice</h1>
    <p className=' pt-1 md:text-lg'> Black rice has more antioxidant properties than coffee and tea, due to which it is beneficial
        ...
        vitamin E, vitamin B, calcium and zinc are present in black rice as compared to white and brown rice.</p>

    <div className='pt-2'>
        <h2 className='font-semibold  text-2xl py-1 border-b-[#af7501] mb-3 border-b text-[#0f5f17]'>Nutritional Information</h2>
        <table id='customers'>
            <tr>
                <th>Nutrients</th>
                <th>Value</th>

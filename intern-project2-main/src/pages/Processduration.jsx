  ...
  return (
    <div className='lg:px-28 md:px-12 sm:px-5 px-3  lg:py-8 py-4'>
        ...
        <h1 className=' font-semibold sm:text-3xl text-[21px]  inline-block px-2 border-b-[#af7501] mb-3 border-b text-[#0f5f17]'>Cultivation of Black Salt Rice</h1>
           ...
           <div className='my-4 md:my-0'>
           <h2 className='font-semibold text-xl py-1 border-b-[#af7501] border-b text-[#0f5f17]'>Black Rice Sowing Method</h2>
                <p className=' pt-1 md:text-lg'>Agricultural scientist Dr. RC Chowdhary says that sowing of black paddy crop should be done around June 15. After this transplant after 20 to 25 days. The species of black paddy
                 is photosensitive, due to which 12 hours of light days are required for the crop to come into ear. If sowing of black salt crop is done earlier, then the leaves and earrings come out at the scheduled time.
Due to which the expenditure of the farmers increases, and there is no special benefit. If the nursery and transplanting of the crop is done on time, then the quality of black rice is good with good aroma. Seeds are planted a year before. Companies provide seeds on the demand letter sent a year ago to the Agriculture Department and other institutions.
 </p>
 </div>         

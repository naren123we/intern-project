  ...
  return (
    ...
    <h1 className='font-semibold sm:text-3xl text-2xl  inline-block pr-2 py-1 border-b-[#af7501] mb-3 border-b-2 text-[#0f5f17]'>How Much Seed Is Required For Cultivation of Black Paddy</h1>
       ...
       <div>
            ...
            black paddy is the most popular variety among farmers.</p>
       ...
       <div className='my-4 md:my-0'>
                 ...
                 <p className=' pt-1 md:text-lg'>In the last few years, the trend of farmers has increased rapidly towards new hybrid paddy seeds. Due to this farmers
                  ...
                  then its crop becomes very long. Due to which there is a fear of falling. For this reason chemical fertilizers are not used in its cultivation. And it is completely free of fertilizers, pesticides and chemicals. 
                  Its main varieties for the cultivation of black paddy are as follows- There are varieties of paddy like Kala Namak, Kala Bhat, JawaPhool, Kala Malli, TilakChandan, but with time the yield of these varieties became nominal.Because of this, 
                  the Agriculture Department is working to save these old varieties. Along with the seeds of these varieties of black paddy, the Agriculture Department is also giving sprayers to the farmers for spraying organic fertilizers and medicines.
                  At the same time, farmers also get advice from agricultural scientists.</p>
